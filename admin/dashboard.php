...
$totalanimal=$result['totalanimal'];
 ?>  
                                        <h3 class="header-title mb-0">動物總量</h3>
...
$count_total_visitors=$result['totaladult'];
 ?>  
                                        <h3 class="header-title mb-0">正常成人旅客量</h3>
...
$count_total_cvisitors=$result['totalchild'];
 ?>  
                                        <h4 class="header-title mb-0">正常幼童旅客量</h4>
...
$count_today_visitors=$result['totaladult'];
 ?>  
                                        <h3 class="header-title mb-0">今日正常成人旅客量</h3>
...
$count_today_cvisitors=$result['totalchild'];
 ?>  
                                        <h4 class="header-title mb-0">今日正常幼童旅客量</h4>
                                        <p style="font-size: 20px;color: red"><?php 
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        <h4 class="header-title mb-0">昨日正常成人旅客量</h4>
...
$count_Yest_cvisitors=$result['totalchildy'];
 ?>
                                        <h4 class="header-title mb-0">昨日正常幼童旅客量</h4>
                                        <p style="font-size: 20px;color: red">
...
$count_total_visitors=$result['totaladult'];
 ?>  
                                        <h3 class="header-title mb-0">外國人成人遊客總數</h3>
                                       <p style="font-size: 20px;color: red">
...
$count_today_visitors=$result['totaladult'];
 ?>  
                                        <h3 class="header-title mb-0">今日外國人成人遊客</h3>
                                       <p style="font-size: 20px;color: red">
...
$count_Yest_visitors=$result['totaladulty'];
 ?>
                                        <h4 class="header-title mb-0">昨日外國人成人訪客
                                        </h4>
                                        <p style="font-size: 20px;color: red">
                                            <?php 
if($count_Yest_visitors==''):
